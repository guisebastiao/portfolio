...
import { useContactSchema } from "@/features/contact/schemas/contact-schema";
import { SendEmailProps } from "@/features/contact/hooks/use-send-mail";
...
export const Contact = () => {
  ...
  return (
    <section
      className="w-full flex items-center justify-center flex-col gap-6 py-8"
      data-container="4"
    >
      <m.div
          ...
          <Button type="submit" disabled={loading} className="w-full">
            {loading ? (
              <div className="size-full flex items-center justify-center gap-3.5">
                ...
                <span>
                  {t("sections.contact.form.submit.button-pending.name")}
                </span>
              </div>
            ) : (
              <div className="size-full flex items-center justify-center gap-2">
                ...
                <span>
                  {t("sections.contact.form.submit.button-normal.name")}
                </span>
              </div>
            )}
          </Button>
      ...
      >
        <AuroraText
          ...
          colors={
            theme === "dark" ? ["#a1a1a1", "#d4d4d4"] : ["#404040", "#737373"]
          }
        >
          {t("sections.contact.contratar.title")}
        </AuroraText>
        <ShimmerButton
          className="max-w-xl w-full h-9 gap-2 font-medium text-sm"
