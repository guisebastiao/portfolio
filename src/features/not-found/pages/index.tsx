...
export const NotFound = () => {
  ...
  return (
    <main className="relative min-h-dvh flex flex-col items-center bg-background overflow-hidden">
      <Meteors />
      <LightEffects count={5} />
      <div className="max-w-xl min-h-screen flex flex-col justify-center items-center gap-12 px-8 py-3.5">
        ...
        <img src="/not-found.png" alt="not-found-img" className="max-w-xs" />
